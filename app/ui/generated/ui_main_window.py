...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.schemeGroupBox.setFrameShape(QFrame.Shape.StyledPanel)
        ...
        self.sourceGroupBox.setFrameShape(QFrame.Shape.StyledPanel)
        ...
        self.rulesGroupBox.setFrameShape(QFrame.Shape.StyledPanel)
        ...
        self.logGroupBox.setFrameShape(QFrame.Shape.StyledPanel)
